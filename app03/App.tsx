...
const PasswordSchema = Yup.object().shape({
  ...
  .max(16,'Should be at max of 16 characters')
...
export default function App() {
  ...
  // lets define the methods to generate the password..
       ...
       {({
         ...
         <>
          <View style={styles.inputWrapper}>
            ...
            <TextInput
               ...
               value={values.passwordLength} // this is important to understand
               onChangeText={handleChange('passwordLength')} // this is also important
               placeholder='Ex.7'
        ...
        {isPassGenerated ? (
          <View style={[styles.card,styles.cardElevated]}>
            ...
            <Text style={styles.description}>Double Tap / Long press to copy</Text>
          </View>
        ):null}
      </SafeAreaView>
    </ScrollView>
